#!/usr/bin/env python3
"""Simulink dynamics backend launcher (park) — bf_sim_bridge + Betaflight SITL + Gazebo vis-only.
...
Process launch order:
    ...
    2. Gazebo        — vis-only world (rocket_drone_vis_park), no physics
...
Usage:
    python3 start_simulink_park.py --display --shm     # SDL2 + shared memory
    python3 start_simulink_park.py --gazebo             # Show Gazebo GUI
    python3 start_simulink_park.py --no-video           # Dynamics only, no video
"""
