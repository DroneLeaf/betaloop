#!/usr/bin/env python3
"""Rocket drone FPV launcher — Betaflight SITL + Gazebo camera → SDL2 display.
...
Usage:
    python3 start_rocket_drone_fpv.py --display --shm               # SDL2 + shared memory
    python3 start_rocket_drone_fpv.py --display --shm --chase-cam   # + chase camera
    python3 start_rocket_drone_fpv.py --display --shm --osd         # + OSD overlay
"""
