#!/usr/bin/env python3
"""Rocket drone FPV park (real target trajectory) launcher — Betaflight SITL + Gazebo camera → SDL2 display.
...
Usage:
    python3 start_rocket_drone_fpv_park_real_target_traj.py --display --shm
    python3 start_rocket_drone_fpv_park_real_target_traj.py --display --shm --chase-cam
    python3 start_rocket_drone_fpv_park_real_target_traj.py --display --shm --osd
"""
...
def main():
    ...
    # ── 8. Chase camera (optional, SDL2 window) ──
    ...
    print()
    print("=" * 60)
    print("  FPV Simulation Running  (SDL2 display)")
    print("=" * 60)
    print()
